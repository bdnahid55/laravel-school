...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Edit Menu')
@section('content')
    <!-- alert -->
            ...
            <div class="card card-box">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <i class="fas fa-table me-1"></i>Edit Menu
                        </div>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.menu.update-menu', $menudata->id) }}" method="POST">
                        @csrf

                        <div class="form-group mb-3">
                            <label for="">Menu Title</label>
                            <input type="text" name="name" class="form-control" value="{{ $menudata->name }}"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" name="parent_id">
                                <option value="{{ $menudata->parent_id }}" selected>{{ $menudata->parent_id }}</option>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="url" name="url" class="form-control" value="{{ $menudata->url }}"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="order" class="form-control" value="{{ $menudata->order }}"
