...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Update School history')
@section('content')
    {{-- --- --}}
                ...
                <div class="card card-box">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <i class="fas fa-table me-1"></i>Update School history
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.schoolhistory.update-schoolhistory') }}" method="POST" enctype="multipart/form-data">
                            @csrf
