...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'All download')
@section('content')
    <!-- alert -->
    ...
    <div class="card-box mb-30">
        <div class="pd-20">
            <h4 class="text-blue h4">All download list</h4>
        </div>
        <div class="pb-20">
                    ...
                    @forelse ($downloads as $download)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.download.edit-download', $download->id) }}"
                                    class="btn btn-square btn-warning waves-effect waves-light"><i
                                        class="fa fa-pencil"></i></a>
                                <a href="{{ route('admin.download.delete-download', $download->id) }}"
